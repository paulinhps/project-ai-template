...
- If sync is requested, use the Skill tool to invoke `openspec-sync-specs` when available; otherwise run the sync workflow inline from `.ai/skills/openspec-sync-specs/SKILL.md`
